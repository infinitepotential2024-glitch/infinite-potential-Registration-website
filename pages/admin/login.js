  ...
  return (
    <Layout>
      <div className="center" style={{ maxWidth: 480 }}>
        ...
        <p className="hint">This page is for the coaching centre only. Student registrations never require sign-in.</p>
        <form className="card" onSubmit={submit}>
          ...
          <button className="btn btn-primary" disabled={busy} type="submit">{busy ? <span className="spinner" /> : null} Sign in</button>
        </form>
      </div>
    </Layout>
  );
